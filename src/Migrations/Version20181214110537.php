 ...
 */
final class Version20181214110537 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taches CHANGE etapes_id etapes_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taches CHANGE etapes_id etapes_id INT NOT NULL');
