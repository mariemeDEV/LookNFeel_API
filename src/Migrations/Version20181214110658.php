 ...
 */
final class Version20181214110658 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taches ADD etapes_id INT DEFAULT NULL, DROP id_etape');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_3BF2CD984F5CEED2 ON taches');
        $this->addSql('ALTER TABLE taches ADD id_etape INT NOT NULL, DROP etapes_id');
        $this->addSql('CREATE INDEX IDX_3BF2CD984F5CEED2 ON taches (id_etape)');
